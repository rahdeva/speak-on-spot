...
export const valentineStatements = [
    "Love starts with self-acceptance.",
    "Healthy relationships require clear communication.",
    "Appreciation is the language of love.",
    ...
    "Quality time matters more than material gifts.",
    ...
    "Mutual respect creates healthy boundaries.",
    "Kindness costs nothing but means everything.",
    "Real connection happens when we're truly present.",
    "Loving someone means accepting their imperfections.",
    "Communication can resolve most conflicts.",
    "Love is a choice we make every day.",
    "Supporting each other's growth shows true love.",
    "Honesty builds deeper connections.",
    "Love means showing up, even when it's hard.",
    "Celebrating small moments creates lasting memories.",
    "Patience is essential in all relationships.",
    "Appreciation deepens over time.",
    "Kindness is the simplest form of love.",
];

export const independenceStatements = [
    "Independence is a gift we must protect together.",
    "Unity in diversity is Indonesia's greatest strength.",
    "Freedom was won through sacrifice, not given for free.",
    "Loving your country starts with small daily actions.",
    "Gotong royong builds stronger communities.",
    "The youth are the future of the nation.",
    "A great nation honors the services of its heroes.",
    "Diversity is something to celebrate, not to fear.",
    "Education is the key to a nation's progress.",
    "True patriotism is shown through action, not just words.",
    "Local culture deserves to be preserved and shared.",
    "Every generation has its own struggle to fight.",
    "The red and white flag unites us all.",
    "National progress begins with personal responsibility.",
    "Respecting differences keeps the nation united.",
    "Independence means the freedom to shape our own future.",
    "Small contributions from everyone build a great nation.",
    "History teaches us to never take freedom for granted.",
    "Working together achieves more than working alone.",
    "Pride in your country inspires you to improve it.",
    "The spirit of independence lives beyond one day of celebration.",
    "Heroes are ordinary people who make extraordinary sacrifices.",
    "A strong nation is built on honest and hardworking citizens.",
    "Cultural heritage connects the past with the future.",
